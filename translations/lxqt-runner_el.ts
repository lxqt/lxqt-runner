...
this value is only for the smallest screen. The minimum width is 400 px.</source>
        <translation>Με πολλαπλές οθόνες, αν το παράθυρο εμφανίζεται στην επιλεγμένη οθόνη,
αυτή η τιμή ισχύει μόνο για την μικρότερη οθόνη. Το ελάχιστο πλάτος είναι 400 εικ.</translation>
    </message>
    <message>
...
in the compositor settings for &apos;lxqt-runner&apos;.</source>
        <translation>Για το Wayland, η συντόμευση πρέπει να προστεθεί
στις ρυθμίσεις του συνθέτη για το &apos;lxqt-runner&apos;.</translation>
    </message>
    <message>
